            ...
            <div class="col-xl-6">
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        ...
                        <form class="needs-validation" novalidate method="POST" action="{{ route('msw.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="title" name="title" value="" class="form-control" placeholder="title text">
