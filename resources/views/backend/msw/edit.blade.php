                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('msw.update',$items->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="title" name="title" value="{{ @$items->title }}" class="form-control" placeholder="title text">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <div class="input-group">
                                                <textarea name="image_text_2" id="description" class="js-summernote">{{ @$items->des }}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="brand" id="parent" class="form-control">
                                                    @foreach ($brands as $smenu)
                                                        <option {{ $smenu->id == @$items->brand_id ? 'selected' : '' }} value="{{ $smenu->id }}">{{ $smenu->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <br>
                                            <img src="{{ asset(@$items->img) }}" alt="image" width="250" height="100" id="upload_image">
                                        </div>
