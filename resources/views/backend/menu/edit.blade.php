                        ...
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('menu.update',$menuData->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="h_title" name="h_title" value="{{ @$menuData->h_title }}" placeholder="Heading">
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <img src="{{ asset($menuData->background_image) }}" id="upload_image" width="200" height="100">
                                            @else
                                            <img src="" id="upload_image" width="200" height="100">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Update Menu</button>
                                </div>
                            </form>
                            <script>
