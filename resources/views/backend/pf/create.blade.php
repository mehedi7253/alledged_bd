                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('pf.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-12 mb-12">
                                    ...
                                    <div class="input-group">
                                        <textarea name="des" id="description" class="js-summernote"></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="des" value="{{ old('name') }}" placeholder="Description" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="icon" value="{{ old('name') }}" placeholder="Icon" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
