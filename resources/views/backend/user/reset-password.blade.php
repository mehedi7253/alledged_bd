            ...
            <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                <form action="{{ route('password.reset') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" required id="password_confirmation" class="form-control" value="{{ old('password_confirmation') }}" placeholder="confirmation password" name="password_confirmation">
                        <span class="help-block">
                            Confirm password
                        </span>
                    </div>
