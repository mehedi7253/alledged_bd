                        ...
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('user.update',$user->id) }}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="phone" placeholder="Phone number" name="phone" value="{{ $user->phone }}" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                    ...
                                    <div class="form-row form-group">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email" placeholder="Email" value="{{ $user->email }}" name="email" aria-describedby="inputGroupPrepend2" required>
                                                <div class="invalid-tooltip">
                                                ...
                                                <select required name="roles[]" class="select2 form-control" multiple="multiple" id="multiple-label">
                                                    <optgroup label="Choose roles">
                                                        @foreach ($roles as $role)
                                                            <option <?php if(in_array($role->name,$userRole)){ ?> selected <?php } ?> value="{{ $role->id }}">{{ $role->name }}</option>
                                                        @endforeach
                                                    </optgroup>
                                                </select>
                                                <div class="invalid-tooltip">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Update Info</button>
                                </div>
                            </form>
                            <script>
