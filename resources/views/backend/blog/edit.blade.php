                        ...
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('blog.update',$blog->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{ $blog->name }}" placeholder="Name" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                            ...
                                            <div class="input-group">
                                                <select name="brand_id" id="brand_id" class="form-control select2" required>
                                                    ...
                                                    @foreach ($socialLink as $social)
                                                        <option {{ $blog->brand_id == $social->id ? 'selected' : '' }} value="{{ $social->id }}">{{ $social->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="page_title" name="page_title" value="{{ @$blog->page_title }}" placeholder="Page title" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="page_description" value="{{ @$blog->page_description }}" placeholder="Page Description" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <img src="{{ asset($blog->image) }}" alt="image" width="100" height="100" id="upload_image">
                                        </div>
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <object type="application/pdf" data="{{ asset($blog->pdf_file) }}" id="pdfViewer">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="video_code" id="video_code" class="form-control" value="{{ $blog->video_code }}" placeholder="Embed Video Code">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Update Product</button>
                                </div>
                            </form>
                            <script>
