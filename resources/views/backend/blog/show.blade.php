                        ...
                        <div class="panel-content p-0">
                            {{-- <form class="needs-validation" novalidate method="POST" action="{{ route('blog.update',$blog->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="panel-content">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                <select name="brand_id" id="brand_id" class="form-control select2" disabled>
                                                    <option value="">Choose one</option>
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input readonly name="video_code" id="video_code" class="form-control" value="{{ $blog->video_code }}" placeholder="Embed Video Code">
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                                    Please choose a embed code.
                                                </div>
                                            </div><br>
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <a href="{{ route('blog.edit',$blog->id) }}" class="btn btn-info ml-auto">Product Edit</a>
                                </div>
                            {{-- </form> --}}
                            <script>
