  ...
  var methods = {
      init: function(options){
          ...
          $options.each(function(i,el){
                ...
                dropdown.append('<div class="clip-icon"><img style="width:40%" onclick="jQuery(\'select[name=' + selectName + ']\').val(\''+ $(el).val() + '\').ImageSelect(\'close\').ImageSelect(\'update\',{src:\''+ $(el).text() + '\'});" src="' + $(el).text() + '"/></div>');
          });
